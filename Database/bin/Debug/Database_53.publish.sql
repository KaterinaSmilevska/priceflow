...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022DEV\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022DEV\MSSQL\DATA\"
...
CREATE TABLE [dbo].[DnevenPromet] (
    ...
    CONSTRAINT [un_DnevenPromet_Datum_HVId] UNIQUE NONCLUSTERED ([Datum] ASC, [HVId] ASC)
);
