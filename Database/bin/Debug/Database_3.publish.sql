...
VALUES
('Katerina Smilevska', 'Katerina', 'admin', 'smilevskakaterina5@gmail.com', N'Админ');
INSERT INTO [dbo].[Izdavach] (Ime, Grad, Drzava, SektorId)
SELECT i.Ime, i.Grad, i.Drzava, i.SektorId
FROM (
	VALUES
...
SELECT hv.ISIN, hv.Kod, hv.VkupenBrojAkcii, hv.TipHVId, hv.IzdavachId
FROM (
	VALUES
...
SELECT IzdavachId, Godina, OperativnaDobivka, NetoDobivkaPoAkcija, KoefCenaDobivkaPoAkcija,
KnigovodstvenaVrednostPoAkcija, KoefCenaKnigovodstvenaVrednostPoAkcija, DividendaPoAkcija, DividendenPrinos
FROM (
VALUES
