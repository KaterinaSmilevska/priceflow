...
FROM (
VALUES
	(N'Алкалоид АД Скопје', 2025, 2223582, 1254.61, 19.92, 10773.35, 2.32, NULL, 0.00),
	...
	(N'Комерцијална банка АД Скопје', 2025, NULL, 2253.26, 12.36, 10202.68, 2.73, NULL, 0.00),
	...
	(N'Стопанска банка АД Скопје', 2025, NULL, 191.12, 13.72, 1640.59, 1.60, NULL, 0.00),
	...
	(N'ТТК банка АД Скопје', 2025, NULL, 87.11, 18.94, 1274.10, 1.30, NULL, 0.00),
	...
	(N'НЛБ банка АД Скопје', 2025, NULL, 5713.22, 9.87, 25868.25, 2.18, NULL, 0.00),
	...
	(N'Македонски Телеком АД Скопје', 2025, 2875321, 26.45, 17.39, 169.36, 2.72, NULL, 0.00),
